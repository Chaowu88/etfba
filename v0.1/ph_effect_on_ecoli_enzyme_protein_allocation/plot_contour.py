...
PATHWAYS = ['glycolysis', 'pentose phosphate pathway', 'TCA cycle']			  
NPOINTS = 20
...
def plot_contour(out_dir, filename, data_file, cmap, constant_color):
	...
	for pathway in PATHWAYS:
		...
		for i, enz in enumerate(enzymes+['sum']):
			...
			if vmax - vmin > 0.00005:
				ctf = axes[indexer].contourf(X_phin, Y_phout, Z, vmin = vmin, vmax = vmax, levels = levels, cmap = cmap)
